...
Lomi terminates public traffic and is the only Acme component exposed to
...
| `LOMI_PORT_BIND_FAILED`      | `acme.gateway.public_port` already in use      | Another process holds the port                |
...
Lomi is the most alerted-on component in Acme and the least often at
