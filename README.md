...
- ⚠️ BM25 ranks a **superseded 2024 doc #1** — its fix references a file deleted a year ago.
...
- 🕸️ A 3-hop graph traversal **misses the one component** that actually paged on-call.
